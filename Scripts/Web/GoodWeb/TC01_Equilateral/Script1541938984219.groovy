...
WebUI.setText(findTestObject('Object Repository/GoodWeb/Page_/input_ C_cSide'), '100')

WebUI.click(findTestObject('Object Repository/GoodWeb/Page_/a_'))

WebUI.verifyElementText(findTestObject('GoodWeb/Page_/div_Equilateral'), 'Equilateral')
